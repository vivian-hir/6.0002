...
from ps2 import create_graph, find_shortest_path, find_shortest_path_no_traffic, find_shortest_path_in_traffic, find_shortest_path_restricted
import unittest
...
class InternalPs2Test(unittest.TestCase):
    ...
    def test_3_small_map_three_step(self):
        expected_path = [self.n3, self.n0, self.n1, self.n2]
        expected_time = 25
        self._test_path(self.small_map, expected_path=expected_path, expected_time=expected_time,
    ...
    def test_3_map3_path_restricted_path(self):
        ...
        self._test_impossible_path(self.road_map, start, end, restricted_roads=restricted_roads,
    ...
    def test_3_path_multiple_roads_not_allowed(self):
        start_no_hill = self.n0
        end_no_hill = self.n2
        start_no_local = self.n3
        end_no_local = self.n7
        restricted_roads = ['hill', 'local']
        self._test_impossible_path(self.road_map, start_no_hill, end_no_hill, restricted_roads=restricted_roads,
                                   message='Should be impossible. Make sure your code can handle multiple restricted roads')
        self._test_impossible_path(self.road_map, start_no_local, end_no_local, restricted_roads=restricted_roads,
                                   message='Should be impossible. Make sure your code can handle multiple restricted roads')
    ...
    def test_3_map_traverse_hill(self):
        expected_path = [self.n2, self.n0, self.n1]
        expected_time = 16.75
        self._test_path(self.road_map, expected_path=expected_path, expected_time=expected_time,
    ...
    def test_4a_find_shortest_path_no_traffic(self):
        ...
        expected_path = [Node('N0'), Node('N1'), Node('N3'), Node('N6'), Node('N7'), Node('N9')]
        expected_time = 34
        student_result = find_shortest_path_no_traffic(ROADMAP_FILENAME, start, end)
        self.assertEqual(list, type(student_result[0]), "Make sure you are returning the correct type")
        self.assertEqual(expected_path, student_result[0], "Make sure your find_shortest_path_no_traffic is correct")
        self.assertEqual(expected_time, student_result[1], "Make sure you are calculating the correct time with no_traffic")
    ...
    def test_4b_find_shortest_path_restricted_avoid_local(self):
        ...
        self.assertEqual(student_path, None, "Should be impossible without local roads")

    def test_4b_find_shortest_path_restricted_avoid_hill(self):
        start, end = Node('N0'), Node('N3')
        expected_path = [Node('N0'), Node('N1'), Node('N3')]
        student_path = find_shortest_path_restricted(ROADMAP_FILENAME, start, end)[0]
    ...
    def test_4c_find_shortest_path_in_traffic(self):
        start, end = Node('N0'), Node('N9')
        expected_path = [Node('N0'), Node('N1'), Node('N3'), Node('N6'), Node('N7'), Node('N9')]
        expected_time = 83
        student_result = find_shortest_path_in_traffic(ROADMAP_FILENAME, start, end)
        self.assertEqual(list, type(student_result[0]), "Make sure you are returning the correct type")
        self.assertEqual(expected_path, student_result[0], "Make sure your find_shortest_path_no_traffic is correct")
        self.assertEqual(expected_time, student_result[1], "Make sure you are calculating the correct time with no_traffic")
