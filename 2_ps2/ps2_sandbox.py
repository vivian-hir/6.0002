...
class GraphVisualizer():
    ...
    def plot_part3_shortest_path(self, start, end):
        ...
        true_path = nx.shortest_path(net, start, end, weight='label')
        ...
        pydot_graph.write_png('ps2_part3_sandbox.png')

        im = pylab.imread('ps2_part3_sandbox.png')
...
if __name__ == '__main__':
    ...
    if args[0] == "2":
        ...
        grapher.plot_part3_shortest_path(start, end)
