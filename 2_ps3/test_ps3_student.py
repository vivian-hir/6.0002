...
class ps3_P3(unittest.TestCase):
    """This  tests Room and BasicRobot in various ways"""
    ...
    def test_BoundaryConditions(self):
        "Test strict inequalities in random positions for the Room and BasicRobot"
        for m in range(7000):
...
class ps3_P5_Normal(SimulationTester):
    """test the simulation time cleaning the Room with a BasicRobot"""
...
class ps3_P5_Clumsy(SimulationTester):
    """test the simulation time cleaning the Room with a FaultyRobot"""
    def testClumsySimulation1(self):
        "Test cleaning 100% of a 5x5 room with FaultyRobot"
        ps3.FaultyRobot.set_dust_probability(0.03)
        self.run_simulation(((203, 281),), (1, 1.0, 1, 5, 5, 1, 1.0, 100, ps3.FaultyRobot))
    def testClumsySimulation2(self):
        "Test cleaning 75% of a 10x10 room with FaultyRobot"
        ps3.FaultyRobot.set_dust_probability(0.10)
        self.run_simulation(((252, 287),), (1, 1.0, 1, 10, 10, 1, 0.75, 100, ps3.FaultyRobot))
    def testClumsySimulation3(self):
        "Test cleaning 100% of a 5x5 room with 2 FaultyRobots"
        ps3.FaultyRobot.set_dust_probability(0.12)
        self.run_simulation(((836,1362),),(2, 1.0, 2, 5, 5, 5, 1.0, 100, ps3.FaultyRobot))
    def testClumsySimulation4(self):
        "Test cleaning 75% of a 10x10 room with 4 FaultyRobots"
        ps3.FaultyRobot.set_dust_probability(0.16)
        self.run_simulation(((135,149),),(4, 1.0, 3, 10, 10, 5, 0.75, 100, ps3.FaultyRobot))

class ps3_P5_Sensing(SimulationTester):
    """test the simulation time cleaning the Room with a SmartRobot"""
    def testSensingSimulation1(self):
        "Test cleaning 100% of a 5x5 room with SmartRobot"
        self.run_simulation(((41, 56),), (1, 1.0, 1, 5, 5, 1, 1.0, 100, ps3.SmartRobot))
    def testSensingSimulation2(self):
        "Test cleaning 75% of a 10x10 room with SmartRobot"
        self.run_simulation(((91, 107),), (1, 1.0, 1, 10, 10, 1, 0.75, 100, ps3.SmartRobot))
    def testSensingSimulation3(self):
        "Test cleaning 90% of a 10x10 room with SmartRobot"
        self.run_simulation(((143, 169),), (1, 1.0, 1, 10, 10, 1, 0.9, 100, ps3.SmartRobot))
    def testSensingSimulation4(self):
        "Test cleaning 100% of a 5x5 room with 2 SmartRobots"
        self.run_simulation(((46, 53),), (2, 1.0, 2, 5, 5, 5, 1.0, 100, ps3.SmartRobot))
    def testSensingSimulation5(self):
        "Test cleaning 75% of a 10x10 room with 3 SmartRobots"
        self.run_simulation(((46, 50),), (4, 1.0, 3, 10, 10, 5, 0.75, 100, ps3.SmartRobot))
    def testSensingSimulation6(self):
        "Test cleaning 90% of a 10x10 room with 3 SmartRobots"
        self.run_simulation(((84, 89),), (5, 1.0, 3, 10, 10, 10, 0.9, 100, ps3.SmartRobot))
